  ...
  return (
    <div className="game-card p-8">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-sm text-[var(--text-secondary)]">Login to WarisanVerse</p>
      </div>
      ...
      <form onSubmit={handleLogin} className="space-y-4">
        ...
        >
          {loading ? 'Entering...' : 'Enter WarisanVerse'}
        </button>
      </form>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 batik-bg">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/3 left-1/4 w-72 h-72 bg-primary-600/10 rounded-full blur-3xl animate-float" />
        <div className="absolute bottom-1/3 right-1/4 w-64 h-64 bg-neon-cyan/5 rounded-full blur-3xl animate-float" style={{ animationDelay: '1.5s' }} />
      </div>
